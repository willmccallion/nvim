...
vim.keymap.set("n", "j", "<Plug>(accelerated_jk_gj)", { desc = "Move down (speeds up while held)" })
vim.keymap.set("n", "k", "<Plug>(accelerated_jk_gk)", { desc = "Move up (speeds up while held)" })
