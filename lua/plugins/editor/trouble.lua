...
vim.keymap.set("n", "<leader>dd", "<cmd>Trouble diagnostics toggle win.position=right win.size=0.4 win.wo.wrap=true win.wo.linebreak=true win.wo.breakindent=true<cr>", { desc = "Toggle all project diagnostics errors warnings" })
